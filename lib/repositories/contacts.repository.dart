...
class ContactsRepository {
  ...
  Map<int,Contact> contacts = {
    1:Contact(id: 1, name: 'ayoub', profile: 'MO', type: 'STUDENT', score: 10),
    2:Contact(id: 2, name: 'mohammed', profile: 'ZA', type: 'DEVELOPER', score: 22),
    3:Contact(id: 3, name: 'bader', profile: 'AM', type: 'STUDENT', score: 33),
